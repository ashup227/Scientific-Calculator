...
btnsq = Button(calc, text="\u221A",width=6, height=2,
			bg='silver', font=('Helvetica', 20,'bold'),
...
btnPM = Button(calc, text=chr(177),width=6,
			height=2,bg='silver', font=('Helvetica',20,'bold'),
...
lblDisplay = Label(calc, text = "Canon Scientific Calculator",
				font=('Italics',25,'bold'),
